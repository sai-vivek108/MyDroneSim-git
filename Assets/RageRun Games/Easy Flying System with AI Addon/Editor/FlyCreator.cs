...
namespace RageRunGames.EasyFlyingSystem
{
    public static class FlyCreator
    {
        ...
        {
            MobileInputHandler inputHandler = GameObject.FindFirstObjectByType<MobileInputHandler>();
        ...
        [MenuItem("Tools/Easy Flying System/Create Flyable Object For AI")]
        [MenuItem("GameObject/Easy Flying System/Create Flyable Object For AI")]
        public static void CreateFlyableAIObject()
        {
            MobileInputHandler inputHandler = GameObject.FindFirstObjectByType<MobileInputHandler>();
            ...
            CreateDrone(InputType.AI);

            if (flyObject.GetComponent<AIInputHandler>() == null)
            {
                flyObject.AddComponent<AIInputHandler>();
            }
        }
        ...
        {
            DroneController = GameObject.FindFirstObjectByType<DroneController>();
